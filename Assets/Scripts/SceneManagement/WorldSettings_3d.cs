...
public class WorldSettings_3d : MonoBehaviour
{
    ...
    public const float MAX_EARTH = 10;
    public const float MIN_HEAT = 0;
    public const float MAX_HEAT = 10;
    public const float MIN_WATER = 0;
    public const float MAX_WATER = 10;
    ...
    public static WorldSettings_3d instance { get; private set; }
    /// <summary>
